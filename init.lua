...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, 'PmenuThumb', { bg = '#89B4FA' }) -- Pmenu thumb color
      vim.api.nvim_set_hl(0, 'CmpItemAbbr', { fg = '#A9B1D6' }) -- Item abbreviation color
      vim.api.nvim_set_hl(0, 'CmpItemAbbrMatch', { fg = '#89B4FA' }) -- Match highlight color
      vim.api.nvim_set_hl(0, 'CmpItemKind', { fg = '#F7768E' }) -- Kind color
    end,
  },
